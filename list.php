        ...
        <section class="container">
            ...
            <div class="card-columns">
                ...
                <div class="card p-3 text-white bg-dark" style="max-width: 20rem;">
                    <div class="card-body">
                        <h3 class="card-title" style="margin-bottom: 2px;"><?php echo es($pro_lang->getName()); ?></h3>
                        ...
                        <a class="btn btn-danger" href="list.php?id=<?php echo es($pro_lang->getId()); ?>" role="button"><i
                                    class="icon-remove"></i> 削除</a>
                        <a class="btn" href="list.php" role="button" style="background-color: #ffffff4a; color:white"><i
